...
export const TAIWAN_CITIES_DISTRICTS = {
  ...
  花蓮縣: ['花蓮市', '新城鄉', '太魯閣', '秀林鄉', '吉安鄉', '壽豐鄉', '鳳林鎮', '光復鄉', '豐濱鄉', '瑞穗鄉', '玉里鎮', '卓溪鄉', '富里鄉'],
...
export const getCityNameEn = (city) => CITY_TRANSLATIONS[city] || city;
...
export const getDistrictsByCity = (city) => TAIWAN_CITIES_DISTRICTS[city] || [];

export const isValidCity = (city) => city in TAIWAN_CITIES_DISTRICTS;
